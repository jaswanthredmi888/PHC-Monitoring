...
export const INITIAL_TELECONSULTATIONS: TeleconsultationRequest[] = [
  {
    ...
    isPregnant: true,
    pregnancyStage: '3rd Trimester (Weeks 28-40+)',
    gestationalWeeks: 32,
    gravidaPara: 'G2P1',
    edd: '2026-11-04',
    maternalRiskFlags: ['Preeclampsia Risk (BP ≥ 140/90)', 'Severe Anemia (Hb < 8.5)'],
  ...
  },
  {
    ...
    clinicalCategory: 'Pediatrics & Child Health',
    pregnancyStatus: 'Not Pregnant (Pediatric Male)',
    vitals: {
      bloodPressure: '90/60',
      heartRate: 120,
      spo2: 97,
  ...
  },
  {
    ...
    isPregnant: false,
    pregnancyStage: 'Not Pregnant',
    clinicalCategory: 'Infectious Disease / Vector-Borne',
    pregnancyStatus: 'Not Pregnant (Elderly Male)',
    vitals: {
  ...
  },
  {
    ...
    isPregnant: false,
    pregnancyStage: 'Postpartum (0-6 Months)',
    gravidaPara: 'G1P1',
    clinicalCategory: 'Postnatal & Lactation Care',
    pregnancyStatus: 'Postpartum Day 14 (Lactating)',
    vitals: {
  ...
  {
    id: 'TC-2026-805',
    patientName: 'Sneha Sachin Deshmukh',
    patientAge: 22,
    patientGender: 'Female',
    patientPhone: '+91 98224 88190',
    abhaId: '27-3312-7801-4421',
    district: 'Nashik District',
    taluka: 'Trimbakeshwar Tribal Taluka',
    village: 'Trimbak Tribal Pada, Nashik',
    sector: 'TRIMBAKESHWAR TRIBAL PHC',
    source: 'ASHA Field Worker',
    bookedBy: 'ASHA Kavita Gaikwad',
    requestTime: '11:05 AM (Today)',
    urgency: 'High',
    specialty: 'OB/GYN & Maternal',
    symptoms: '1st Trimester (9 Weeks), persistent severe nausea/hyperemesis gravidarum, dehydration, inability to retain fluids for 2 days.',
    isPregnant: true,
    pregnancyStage: '1st Trimester (Weeks 1-12)',
    gestationalWeeks: 9,
    gravidaPara: 'G1P0',
    edd: '2027-04-12',
    maternalRiskFlags: ['Severe Dehydration / Hyperemesis'],
    pregnancyStatus: 'Pregnant (1st Trimester - 9 Wks)',
    vitals: {
